        ...
        responseSchema: {
          ...
          properties: {
            ...
            executive_summary: {
                type: Type.OBJECT, 
                properties: {
                    mevcut_durum: { type: Type.STRING, description: "Markdown formatında analiz raporu. KURALLAR: 1. GİRİŞ: Genel bir özet cümlesi ile başla. 2. DERS BAZLI AYRIŞTIRMA: Sınavdaki HER BİR DERS (Türkçe, Matematik, Fen, İnkılap, Din, İngilizce) için AYRI BİR PARAGRAF oluştur. Dersleri asla birleştirme. 3. RENKLENDİRME: Ders isimlerini metin içinde kullanırken MUTLAKA şu HTML etiketleriyle sarmala: <span class='text-blue-300 font-bold'>Matematik</span>, <span class='text-red-300 font-bold'>Türkçe</span>, <span class='text-emerald-300 font-bold'>Fen Bilimleri</span>, <span class='text-amber-300 font-bold'>T.C. İnkılap Tarihi</span>, <span class='text-pink-300 font-bold'>İngilizce</span>, <span class='text-purple-300 font-bold'>Din Kültürü</span>. 4. SANDVİÇ TEKNİĞİ (TONLAMA): Her ders paragrafında şu sırayı izle: A) Olumlu Başlangıç (Örn: 'Matematik'te X net yaparak güçlü bir giriş yapmışsın.'), B) Yapıcı Gelişim Alanı (Örn: 'Ancak üslü sayılarda kaçan sorular dikkat çekiyor.'), C) Motivasyonel Kapanış (Örn: 'Bu eksiği giderirsen tam puana çok yakınsın.'). Dil yapıcı, koçvari ve motive edici olsun." },
