        ...
        responseSchema: {
          ...
          properties: {
            ...
            executive_summary: {
                type: Type.OBJECT, 
                properties: {
                    mevcut_durum: { type: Type.STRING, description: "Markdown formatında detaylı performans değerlendirme raporu. KURALLAR: 1. YAPILANDIRMA: Genel bir giriş cümlesinden sonra, sınava girdiği HER DERS (Matematik, Türkçe, Fen, İnkılap, Din, İngilizce) için AYRI BİR PARAGRAF/MADDE açarak değerlendirme yap. 2. RENKLENDİRME: Ders isimlerini metin içinde geçerken MUTLAKA şu HTML etiketleriyle yaz: <span class='text-blue-300 font-bold'>Matematik</span>, <span class='text-red-300 font-bold'>Türkçe</span>, <span class='text-emerald-300 font-bold'>Fen Bilimleri</span>, <span class='text-amber-300 font-bold'>T.C. İnkılap Tarihi</span>, <span class='text-pink-300 font-bold'>İngilizce</span>, <span class='text-purple-300 font-bold'>Din Kültürü</span>. 3. İÇERİK VE TON: Her ders değerlendirmesinde 'Sandviç Tekniği' kullan: Önce güçlü/olumlu yanlarını vurgula (net sayısı, iyi olduğu konular), sonra nazikçe eksik/geliştirilmesi gereken noktaları belirt ve yapıcı bir dille bitir. Tonlama 'Aferin, burası harika ama şuraya dikkat edersen fullersin' tadında, motive edici olmalı." },
