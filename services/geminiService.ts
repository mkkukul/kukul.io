  ...
  try {
    ...
    const response = await ai.models.generateContent({
      ...
      config: {
        ...
        // thinkingConfig removed as it is not supported by gemini-1.5-flash
        ...
        responseSchema: {
          ...
          properties: {
            ...
            exams_history: {
                type: Type.ARRAY,
                description: "Belgedeki 'Sınav Listesi' veya 'Geçmiş Sınavlar' tablosunu bul. Tablodaki EN GÜNCEL 5 (BEŞ) SINAVI buraya ekle. Eğer 5'ten fazla sınav varsa eskilerini yoksay, sadece en yeni 5 tanesini al.",
                items: {
                    type: Type.OBJECT,
                    properties: {
